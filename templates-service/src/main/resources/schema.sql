...
CREATE TABLE IF NOT EXISTS DATA_OBJECT_TEMPLATES
(
    id                        BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    object_type_id            BIGINT                                  NOT NULL,
    sequential_number         INTEGER                                 NOT NULL,
    ...
    use_in_protocol_survey    BOOLEAN                                 NOT NULL,
    use_in_protocol_quality   BOOLEAN                                 NOT NULL,
    CONSTRAINT pk_dataOfSurveyObjectTemplate PRIMARY KEY (id)
);
...
(
    ...
    header_id              BIGINT                                  NOT NULL,
    conclusion_template_id BIGINT,
    is_protocol_survey     BOOLEAN                                 NOT NULL,
    is_protocol_quality    BOOLEAN                                 NOT NULL,
